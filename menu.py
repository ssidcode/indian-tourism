...
def agegrp():
  ...
  plt.xticks(a.year,labels=['2014','2015','2016','2017','2018'])
  plt.legend(['0-14 yrs','15-24 yrs','25-34 yrs','35-44 yrs','45-54 yrs','55 yrs & above'])
  plt.show()
...
def agepie():
  ...
  plt.title('Age-wise distribution of visitors',fontdict=fd,pad=20)
  plt.show()
...
def trans():
  ...
  plt.title('Mode of transport',fontdict=fd,pad=20)
  plt.show()
